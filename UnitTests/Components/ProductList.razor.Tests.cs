...
namespace UnitTests.Components
{
    ...
    public class ProductListTests : BunitTestContext
    {
        ...
        public void ProductList_Valid_Default_Should_Return_Content()
        {
            ...
            var product = TestHelper.ProductService.CreateProduct(new ProductModel() { Title = title });
        ...
        /// <summary>
        /// Unit test on ProductList with product that has existing ratings
        /// </summary>
        [Test]
        public void ProductList_Valid_ID_With_Ratings_Should_Return_Content()
        {
            // Arrange
            Services.AddSingleton<JsonFileProductService>(TestHelper.ProductService);
            ...
            // Create a test product with preset title and ratings
        ...
        /// </summary>
        [Test]
        public void ProductList_Valid_ID_Click_Unstared_Should_Increment_Count_And_Check_Star()
        {
            // Arrange
            Services.AddSingleton<JsonFileProductService>(TestHelper.ProductService);
